...
exports.LANSharingService = void 0;
const dgram = __importStar(require("dgram"));
const crypto = __importStar(require("crypto"));
const os = __importStar(require("os"));
const events_1 = require("events");
class LANSharingService extends events_1.EventEmitter {
    constructor() {
        super();
        this.socket = null;
        this.isRunning = false;
        this.discoveryPort = 45678;
        this.multicastAddress = '224.0.0.88'; // Use  multicast IP
        this.peers = new Map();
        this.cleanupInterval = null;
        this.announceInterval = null;
        this.peerTimeoutMs = 30000; // 30 seconds
     ...
     */
    shareWithPeer(peerId, servers, pairingCode) {
        const peer = this.peers.get(peerId);
        if (!peer) {
     ...
     */
    requestFromPeer(peerId, pairingCode) {
        const peer = this.peers.get(peerId);
        if (!peer) {
            return false;
        }
     ...
     */
    handleSenderFound(packet, rinfo) {
...
exports.LANSharingService = LANSharingService;
//# sourceMappingURL=LANSharingService.js.map